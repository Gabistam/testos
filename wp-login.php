...
<html lang="fr-FR">
	...
	<title>Se connecter &lsaquo; testoss &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.2.2" media="all">
	...
	<link rel="icon" href="/wp-content/uploads/2023/06/cropped-php-logo-32x32.png" sizes="32x32">
<link rel="icon" href="/wp-content/uploads/2023/06/cropped-php-logo-192x192.png" sizes="192x192">
<link rel="apple-touch-icon" href="/wp-content/uploads/2023/06/cropped-php-logo-180x180.png">
<meta name="msapplication-TileImage" content="/wp-content/uploads/2023/06/cropped-php-logo-270x270.png">
	</head>
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/test-wp/wordpress/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Se connecter">
									<input type="hidden" name="redirect_to" value="http://localhost/test-wp/wordpress/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
				<a href="/wp-login.php?action=lostpassword">Mot de passe oublié ?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Aller sur testoss</a>		</p>
			</div>
...
<option value="fr_FR" lang="fr" selected data-installed="1">Français</option></select>
